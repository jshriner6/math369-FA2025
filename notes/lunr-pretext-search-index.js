...
{
  "id": "fig-activity-2-1-2-sols",
  "level": "2",
  "url": "sec-2-1-1-sols.html#fig-activity-2-1-2-sols",
  "type": "Figure",
  "number": "5",
  "title": "",
  "body": " Sketch the vectors on this grid.    An empty coordinate system.    "
...
{
  "id": "fig-activity-2-1-3-sols",
  "level": "2",
  "url": "sec-2-1-1-sols.html#fig-activity-2-1-3-sols",
  "type": "Figure",
  "number": "6",
  "title": "",
  "body": " Sketch the vectors on this grid.    An empty coordinate system.    "
...
},
{
  "id": "sec-2-5-2-sols",
  "level": "1",
  "url": "sec-2-5-2-sols.html",
  "type": "Worksheet",
  "number": "",
  "title": "<span class=\"process-math\">\\(\\S 2.5\\text{:}\\)<\/span> Matrix Transformations and Composition (Solutions)",
  "body": " : Matrix Transformations and Composition (Solutions)    Motivation: Composition       Last time we were introduced to matrices as transformations (functions on vectors). Like functions in one variable, it is often useful to \"chain\" together transformations (composition).  Given two transformations , , and , , we can form the composition transformation .       Activity: Composition   We will explore the composition of matrix transformations by revisiting the matrix transformations from a previous activity.   Let's begin with the matrix transformation that rotates a two-dimensional vector by to produce . We saw in the earlier activity that the associated matrix is . Suppose that we compose this matrix transformation with itself to obtain , which is the result of rotating by twice.   What is the matrix associated to the composition ?    What is the result of rotating twice?    Suppose that is the matrix transformation that rotates vectors by , as shown in .   The matrix transformation takes two-dimensional vectors on the left and rotates them by into the vectors on the right.       Use the vectors to find the matrix associated to and explain why it is the same matrix associated to .    Write the two-dimensional vector . How might this vector be expressed in terms of scalar multiplication and why does this make sense geometrically?       In the previous activity, we imagined a company that operates two bakeries. We found the matrix transformation where describes the number of cakes, doughnuts, and eclairs when Bakery1 runs for hours and Bakery 2 runs for hours. The associated matrix is .  Suppose now that  Each cake requires 4 cups of flour and and 2 cups of sugar.  Each doughnut requires 1 cup of flour and 1 cup of sugar.  Each eclair requires 1 cup of flour and 2 cups of sugar.  We will describe a matrix transformation where is a two-dimensional vector describing the number of cups of flour and sugar required to make cakes, doughnuts, and eclairs.   Use the vectors to write the matrix associated to the transformation .    If we make 1200 cakes, 2850 doughnuts, and 2250 eclairs, how many cups of flour and sugar are required?     Suppose that Bakery 1 operates for 75 hours and Bakery 2 operates for 53 hours. How many cakes, doughnuts, and eclairs are produced? How many cups of flour and sugar are required?    What is the meaning of the composition and what is its associated matrix?    In a certain time interval, both bakeries use a total of 5800 cups of flour and 5980 cups of sugar. How long have the two bakeries been operating?                The matrix is .     .    The matrix associated to is also since rotating by twice is the same as rotating once by .     , which makes sense because multiplying a vector by simply changes its direction.           .     .     and .     takes as input a vector that records the number of hours both bakeries operate and outputs a vector that tells us the total number of cups of flour and sugar used. The associated matrix is .    We want to find the vector for which . Solving this equation gives .             Application: Discrete Dynamical Systems       See Subsection 2.5.3: Discrete Dynamical Systems .     "
},
{
  "id": "sec-2-5-2-sols-2-1",
  "level": "2",
  "url": "sec-2-5-2-sols.html#sec-2-5-2-sols-2-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "Motivation: Composition.",
  "body": " Motivation: Composition       Last time we were introduced to matrices as transformations (functions on vectors). Like functions in one variable, it is often useful to \"chain\" together transformations (composition).  Given two transformations , , and , , we can form the composition transformation .   "
},
{
  "id": "sec-2-5-2-sols-3-1",
  "level": "2",
  "url": "sec-2-5-2-sols.html#sec-2-5-2-sols-3-1",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "Activity: Composition.",
...
{
  "id": "sec-2-5-2-sols-4-1",
  "level": "2",
  "url": "sec-2-5-2-sols.html#sec-2-5-2-sols-4-1",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "Application: Discrete Dynamical Systems.",
...
},
{
  "id": "sec-3-2-1-sols",
  "level": "1",
  "url": "sec-3-2-1-sols.html",
  "type": "Worksheet",
  "number": "",
  "title": "<span class=\"process-math\">\\(\\S 3.2\\text{:}\\)<\/span> Bases and Coordinate Systems (Solutions)",
  "body": " : Bases and Coordinate Systems (Solutions)    Motivation: Bases and Coordinate Systems       We intuitively use the vectors and to help us communicate points in . We'll generalize this idea, and see some examples as to why \"changing coordinates\" might be useful.     Preview Activity 3.2.1   Consider the vectors in , which are shown in .     Vectors v1 and v2 in 2 dimensional space.    Linear combinations of and .      Indicate the linear combination on the figure.    We can see graphically, or we can compute, that .      Express the vector as a linear combination of and .    Again, we graphically see that .      Find the linear combination .    Since the linear combination extends beyond the figure, we compute that .      Express the vector as a linear combination of and .    We need to find the solution to the linear system , which is .      Explain why every vector in can be written as a linear combination of and in exactly one way.    The matrix has a pivot position in every row and every column.        Definition: Basis   A set of vectors is a basis for if    the set spans and is a linearly independent set.     Activity: Bases   We will look at some examples of bases in this activity.  In the preview activity, we worked with the set of vectors in : . Explain why these vectors form a basis for .  Consider the set of vectors in  and determine whether they form a basis for .   Do the vectors form a basis for ?  Explain why the vectors form a basis for .  If a set of vectors forms a basis for , what can you guarantee about the pivot positions of the matrix ?  If the set of vectors is a basis for , how many vectors must be in the set?       The matrix is row equivalent to the identity matrix so it has a pivot position in every row. The span of the columns is therefore . There is also a pivot position in every column, which means that the columns are linearly independent.  We note that Since there is a pivot position in every row, the span of the vectors is . Since there is a pivot position in every column, the vectors are linearly independent. Consequently, this set of vectors forms a basis for .  The matrix whose columns are the vectors , , , and has dimensions . Therefore, there cannot be a pivot position in every column, which tells us that the columns cannot be linearly independent. Therefore, the set of vectors do not form a basis for .  Putting these vectors into a matrix produces the identity matrix, which has a pivot position in every row and every column. Therefore, the span of the vectors is , and they are linearly independent.  There must be a pivot position in every row and every column.  A basis for must have vectors. Because the associated matrix must have a pivot position in every row and every column, there must be the same number of columns as there are rows. Since the vectors are -dimensional, there must be 10 vectors.        Fact: Bases   The vectors form a basis for exactly when    the matrix whose columns are the vectors row reduces to the identity matrix. This means that . I.e., it takes linearly independent vectors to form a basis for .  We call the set of vectors the standard basis for .     Bases and Coordinate Systems   Bases are useful because they give us a way to communicate points in space.    A choice of basis creates a coordinate system in which we can communicate vectors based on how they are written as a linear combination of the basis vectors.  See Example 3.2.6 .       Activity: Coordinate Systems   Let's begin with the basis of where .  If the coordinates of in the basis are , what is the vector ?  If , find the coordinates of in the basis ; that is, find .  Find a matrix such that, for any vector , we have . Explain why this matrix is invertible.  Using what you found in the previous part, find a matrix such that, for any vector , we have . What is the relationship between the two matrices and ? Explain why this relationship holds.  Suppose we consider the standard basis . What is the relationship between and ?  Suppose we also consider the basis . Find a matrix that converts coordinates in the basis into coordinates in the basis ; that is, . You may wish to think about converting coordinates from the basis into the standard coordinate system and then into the basis .      We know that .  We solve the linear system to find .  If , we have This matrix , whose columns are the vectors and , has a pivot position in every row and every column because the vectors form a basis. It is, therefore, row equivalent to the identity matrix and hence invertible.  Since we have , we also have .  We have   If we define to be the matrix whose columns are and , then Therefore,         Summary: Change of Coordinates   Let be a basis for , and be the matrix whose columns are the basis vectors.    See Proposition 3.2.7 .     "
},
{
  "id": "sec-3-2-1-sols-2-1",
  "level": "2",
  "url": "sec-3-2-1-sols.html#sec-3-2-1-sols-2-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "Motivation: Bases and Coordinate Systems.",
  "body": " Motivation: Bases and Coordinate Systems       We intuitively use the vectors and to help us communicate points in . We'll generalize this idea, and see some examples as to why \"changing coordinates\" might be useful.   "
},
{
  "id": "sec-3-2-1-sols-2-2",
  "level": "2",
  "url": "sec-3-2-1-sols.html#sec-3-2-1-sols-2-2",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "Preview Activity 3.2.1.",
  "body": " Preview Activity 3.2.1   Consider the vectors in , which are shown in .     Vectors v1 and v2 in 2 dimensional space.    Linear combinations of and .      Indicate the linear combination on the figure.    We can see graphically, or we can compute, that .      Express the vector as a linear combination of and .    Again, we graphically see that .      Find the linear combination .    Since the linear combination extends beyond the figure, we compute that .      Express the vector as a linear combination of and .    We need to find the solution to the linear system , which is .      Explain why every vector in can be written as a linear combination of and in exactly one way.    The matrix has a pivot position in every row and every column.    "
...
{
  "id": "sec-3-2-1-sols-3-1",
  "level": "2",
  "url": "sec-3-2-1-sols.html#sec-3-2-1-sols-3-1",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "Definition: Basis.",
  "body": " Definition: Basis   A set of vectors is a basis for if    the set spans and is a linearly independent set.   "
},
{
  "id": "sec-3-2-1-sols-3-2",
  "level": "2",
  "url": "sec-3-2-1-sols.html#sec-3-2-1-sols-3-2",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "Activity: Bases.",
...
{
  "id": "sec-3-2-1-sols-4-1",
  "level": "2",
  "url": "sec-3-2-1-sols.html#sec-3-2-1-sols-4-1",
  "type": "Worksheet Exercise",
  "number": "5",
  "title": "Fact: Bases.",
  "body": " Fact: Bases   The vectors form a basis for exactly when    the matrix whose columns are the vectors row reduces to the identity matrix. This means that . I.e., it takes linearly independent vectors to form a basis for .  We call the set of vectors the standard basis for .   "
},
{
  "id": "sec-3-2-1-sols-4-2",
  "level": "2",
  "url": "sec-3-2-1-sols.html#sec-3-2-1-sols-4-2",
  "type": "Worksheet Exercise",
  "number": "6",
  "title": "Bases and Coordinate Systems.",
  "body": " Bases and Coordinate Systems   Bases are useful because they give us a way to communicate points in space.    A choice of basis creates a coordinate system in which we can communicate vectors based on how they are written as a linear combination of the basis vectors.  See Example 3.2.6 .   "
},
{
  "id": "sec-3-2-1-sols-5-1",
  "level": "2",
  "url": "sec-3-2-1-sols.html#sec-3-2-1-sols-5-1",
  "type": "Worksheet Exercise",
  "number": "7",
  "title": "Activity: Coordinate Systems.",
...
{
  "id": "sec-3-2-1-sols-6-1",
  "level": "2",
  "url": "sec-3-2-1-sols.html#sec-3-2-1-sols-6-1",
  "type": "Worksheet Exercise",
  "number": "8",
  "title": "Summary: Change of Coordinates.",
  "body": " Summary: Change of Coordinates   Let be a basis for , and be the matrix whose columns are the basis vectors.    See Proposition 3.2.7 .   "
},
{
  "id": "sec-3-2-2",
  "level": "1",
...
},
{
  "id": "sec-3-2-2-sols",
  "level": "1",
  "url": "sec-3-2-2-sols.html",
  "type": "Worksheet",
  "number": "",
  "title": "<span class=\"process-math\">\\(\\S 3.2\\text{:}\\)<\/span> Bases Examples (Solutions)",
  "body": " : Bases Examples (Solutions)    Motivation: Bases       Last time we saw how we can create coordinate systems using bases, and convert data between two coordinate systems.  See Example 3.2.8 for a basic example.  This section will provide some examples illustrating when a basis change could be useful.       Changing Bases: Quarterly Analysis      Text from example 3.2.9 in the textbook.    Change of basis matrices from example 3.2.9 in the textbook.       See Example 3.2.9 .       Activity: Change of Bases and Edge Detection   An important problem in the field of computer vision is to detect edges in a digital photograph, as is shown in . Edge detection algorithms are useful when, say, we want a robot to locate an object in its field of view. Graphic designers also use these algorithms to create artistic effects.     Full color picture of a canyon wall.    The result of the canyon wall picture after an edge detection algorithm.    A canyon wall in Capitol Reef National Park and the result of an edge detection algorithm.   We will consider a very simple version of an edge detection algorithm to give a sense of how this works. Rather than considering a two-dimensional photograph, we will think about a one-dimensional row of pixels in a photograph. The grayscale values of a pixel measure the brightness of a pixel; a grayscale value of 0 corresponds to black, and a value of 255 corresponds to white.  Suppose, for simplicity, that the grayscale values for a row of six pixels are represented by a vector in :    .   Plot of the six pixels and their gray scale values. The first four are close to black, while the last two are close to white.         Activity (continued)   We can easily see that there is a jump in brightness between pixels 4 and 5, but how can we detect it computationally? We will introduce a new basis for with vectors: .  Construct the matrix that relates the standard coordinate system with the coordinates in the basis .  Determine the matrix that converts the representation of in standard coordinates into the coordinate system defined by .   Suppose the vectors are expressed in general terms as . Using the relationship , determine an expression for the coefficient in terms of . What does measure in terms of the grayscale values of the pixels? What does measure in terms of the grayscale values of the pixels?  Now for the specific vector , determine the representation of in the -coordinate system.  Explain how the coefficients in determine the location of the jump in brightness in the grayscale values represented by the vector .    Readers who are familiar with calculus may recognize that this change of basis converts a vector into , the set of changes in . This process is similar to differentiation in calculus. Similarly, the process of converting into the vector adds together the changes in a process similar to integration. As a result, this change of basis represents a linear algebraic version of the Fundamental Theorem of Calculus.     We form the matrix   We find that   We see that so measures the change in brightness between one pixel and its neighbor. Similarly, , which measures another change in brightness.  We compute that   Most of the coefficients that measure changes are relatively small in absolute value. The coefficient , however, which measures the change in brightness between the fourth and fifth pixel, has a large absolute value. This tells us that there is a large change in brightness between the fourth and fifth pixel, which points to an edge in the image.      "
},
{
  "id": "sec-3-2-2-sols-2-1",
  "level": "2",
  "url": "sec-3-2-2-sols.html#sec-3-2-2-sols-2-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "Motivation: Bases.",
  "body": " Motivation: Bases       Last time we saw how we can create coordinate systems using bases, and convert data between two coordinate systems.  See Example 3.2.8 for a basic example.  This section will provide some examples illustrating when a basis change could be useful.   "
},
{
  "id": "sec-3-2-2-sols-3-1",
  "level": "2",
  "url": "sec-3-2-2-sols.html#sec-3-2-2-sols-3-1",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "Changing Bases: Quarterly Analysis.",
  "body": " Changing Bases: Quarterly Analysis      Text from example 3.2.9 in the textbook.    Change of basis matrices from example 3.2.9 in the textbook.       See Example 3.2.9 .   "
},
{
  "id": "sec-3-2-2-sols-4-1",
  "level": "2",
  "url": "sec-3-2-2-sols.html#sec-3-2-2-sols-4-1",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "Activity: Change of Bases and Edge Detection.",
  "body": " Activity: Change of Bases and Edge Detection   An important problem in the field of computer vision is to detect edges in a digital photograph, as is shown in . Edge detection algorithms are useful when, say, we want a robot to locate an object in its field of view. Graphic designers also use these algorithms to create artistic effects.     Full color picture of a canyon wall.    The result of the canyon wall picture after an edge detection algorithm.    A canyon wall in Capitol Reef National Park and the result of an edge detection algorithm.   We will consider a very simple version of an edge detection algorithm to give a sense of how this works. Rather than considering a two-dimensional photograph, we will think about a one-dimensional row of pixels in a photograph. The grayscale values of a pixel measure the brightness of a pixel; a grayscale value of 0 corresponds to black, and a value of 255 corresponds to white.  Suppose, for simplicity, that the grayscale values for a row of six pixels are represented by a vector in :    .   Plot of the six pixels and their gray scale values. The first four are close to black, while the last two are close to white.     "
...
{
  "id": "sec-3-2-2-sols-5-1",
  "level": "2",
  "url": "sec-3-2-2-sols.html#sec-3-2-2-sols-5-1",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "Activity (continued).",
  "body": " Activity (continued)   We can easily see that there is a jump in brightness between pixels 4 and 5, but how can we detect it computationally? We will introduce a new basis for with vectors: .  Construct the matrix that relates the standard coordinate system with the coordinates in the basis .  Determine the matrix that converts the representation of in standard coordinates into the coordinate system defined by .   Suppose the vectors are expressed in general terms as . Using the relationship , determine an expression for the coefficient in terms of . What does measure in terms of the grayscale values of the pixels? What does measure in terms of the grayscale values of the pixels?  Now for the specific vector , determine the representation of in the -coordinate system.  Explain how the coefficients in determine the location of the jump in brightness in the grayscale values represented by the vector .    Readers who are familiar with calculus may recognize that this change of basis converts a vector into , the set of changes in . This process is similar to differentiation in calculus. Similarly, the process of converting into the vector adds together the changes in a process similar to integration. As a result, this change of basis represents a linear algebraic version of the Fundamental Theorem of Calculus.     We form the matrix   We find that   We see that so measures the change in brightness between one pixel and its neighbor. Similarly, , which measures another change in brightness.  We compute that   Most of the coefficients that measure changes are relatively small in absolute value. The coefficient , however, which measures the change in brightness between the fourth and fifth pixel, has a large absolute value. This tells us that there is a large change in brightness between the fourth and fifth pixel, which points to an edge in the image.    "
